...
![](https://files.mdnice.com/user/6935/645d4583-402f-4bf2-8aa4-65c4abb67737.png)
...
![](https://files.mdnice.com/user/6935/86200dd6-1a7c-4e2d-bf72-c73cd35034c6.png)
...
或者表达为：
$$f(\alpha, x)=\{\begin{array}{ll}\alpha\left(e^{x}-1\right) & \text { for } x \leq 0 \\ x & \text { for } x>0\end{array}$$
